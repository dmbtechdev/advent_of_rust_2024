...
impl Santa {
    pub fn give_gift<T: Giftable, U: Gift + Display>(&self, recipient: &mut T, gift: &U) -> Result<(), Box<dyn Error>> {
...
pub fn prepare_gift<T: Gift + Display>(gift: &mut T) {
