...
impl Into<Snowball> for SnowKg {
    fn into(self) -> Snowball {
        // Snowball((*self / SNOWBALL_WEIGHT_KG).round() as i64)
        Snowball::new((*self / SNOWBALL_WEIGHT_KG).round() as i64)
    }
}

impl Into<Snowball> for SnowLb {
    fn into(self) -> Snowball {
        // Snowball((*self / SNOWBALL_WEIGHT_LB).round() as i64)
        Snowball::new((*self / SNOWBALL_WEIGHT_LB).round() as i64)
    }
}
